        ...
        <ul class="nav pull-right top-menu">
          ...
          <li id="mail_notificatoin_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?= base_url('assets/dashboard/') ?>img/avatar-mini.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?= base_url('assets/dashboard/') ?>img/avatar-mini2.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?= base_url('assets/dashboard/') ?>img/avatar-mini3.jpg"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="<?= base_url('assets/dashboard/') ?>img/avatar-mini4.jpg"></span>
                                    <span class="subject">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="<?= base_url('assets/dashboard/') ?>img/avatar1_small.jpg">
                            </span>
              ...
              <div class="panel-body">
                <div class="col-lg-2 col-sm-2">
                  ...
                  <div class="follow-ava">
                    <img src="<?= base_url('assets/dashboard/') ?>img/profile-widget-avatar.jpg" alt="">
                  </div>
                  <h6>Administrator</h6>
                </div>
                    ...
                    <div class="profile-activity">
                      <div class="act-time">
                        <div class="activity-body act-in">
                          ...
                          <div class="text">
                            <a href="#" class="activity-img"><img class="avatar" src="<?= base_url('assets/dashboard/') ?>img/chat-avatar.jpg" alt=""></a>
